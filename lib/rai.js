...
module.exports.raiAction = async function raiAction(action, args = {}) {
...
module.exports.receiveAllPending = async function receiveAllPending(wallet, account) {
    ...
    if (pending) {
        ...
        ({ balance, pending } = await module.exports.getBalance(account));
    }
...
module.exports.walletBalances = async function walletBalances(wallet) {
    await module.exports.raiAction('wallet_balances', { wallet });
}
...
module.exports.waitForBalance = async function waitForBalance(wallet, account, amount, timeout = 120000, delay = 5000) {
