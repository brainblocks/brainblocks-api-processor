...
module.exports.isAccountValid = async function isAccountValid(account) {
    return (await module.exports.raiAction('validate_account_number', { account })).valid === '1';
}
...
module.exports.accountCreate = async function accountCreate() {
    let { private: privateKey, public: publicKey, account } = await module.exports.raiAction('key_create');
...
module.exports.waitForBalance = async function waitForBalance({ account, amount, timeout = 120000, delay = 5000, onCancel = noop }) {
...
module.exports.withPrivate = async function withPrivate(privateKey, handler) {
    let wallet = await module.exports.walletCreate();
    let result = await module.exports.raiAction('wallet_add', { wallet, key: privateKey });
    ...
    await module.exports.removeAccount(wallet, account);
    await module.exports.destroyWallet(wallet);
...
module.exports.recoverAndRefundAccount = async function recoverAndRefundAccount(privateKey) {
    return await module.exports.withPrivate(privateKey, async ({ wallet, account }) => {
